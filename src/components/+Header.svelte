<script>
    ...
    let searching = false;
    let btnClass = 'text-gray-500 inline-flex items-center justify-center dark:text-gray-400 hover:bg-gray-100 w-10 h-10 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5';
    ...
    <Navbar class="bg-white py-2.5 lg:px-8 2xl:px-32" navDivClass="max-[1024px]:max-w-full lg:mx-auto flex flex-wrap justify-between items-center">
        ...
        <section class="right flex items-center">
            ...
            {#if !$page.data.loggedIn}
                <Button href="/login" outline color="light" class="focus:ring-2 h-pixel-36 hidden ml-10 md:inline-flex bg-white text-gray-700 gap-2 justify-center items-center py-1.5 px-3 rounded-md border font-medium shadow-sm align-middle hover:bg-gray-50">
                    Log In
