...
<div class="w-full rounded-xl shadow dark:border md:mt-0 md:max-w-md xl:p-0 bg-white dark:bg-gray-900 dark:border-gray-700">
    <div class="px-5 py-6">
        ...
        <form on:submit={handleSubmit} action="?/login&redirectTo=/" method="post">
            ...
            <div>
                <Button type="submit" outline color="light" class="w-full mb-3 text-base inline-flex bg-white text-gray-700 p-2.5 rounded-md border font-medium shadow-sm align-middle hover:bg-gray-50">
                    {#if waitingForLogin}
