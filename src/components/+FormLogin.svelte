    ...
    <div class="px-5 py-6">
        ...
        <form 
          ...
          >
            ...
            <div>
                <Button on:click={handleSubmit} type="submit" outline color="light" class="focus:ring-2 select-none w-full mb-3 text-base inline-flex bg-white text-gray-700 p-2.5 rounded-md border font-medium shadow-sm align-middle hover:bg-gray-50">
                    {#if waitingForLogin}
