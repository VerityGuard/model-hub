        ...
        <form on:submit>
            <div class="mb-10 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="order-5 md:order-4">
                    ...
                    <input pattern="[a-zA-Z\d-]+" type="text" name="github" id="github" placeholder="John Doe" class="border border-gray-200 text-gray-900 rounded-lg focus:ring-gray-200 focus:border-gray-200 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder:text-gray-300 dark:placeholder:text-gray-500 dark:text-gray-400 dark:focus:ring-gray-500 dark:focus:border-gray-500">
                </div>
                <div class="order-4 md:order-5">
                    <label for="homepage" class="block mb-2 dark:text-gray-400 font-medium">Homepage <span class="pl-1 text-gray-400 dark:text-gray-300 font-normal">(optional)</span></label>
                    <input type="url" name="homepage" id="homepage" placeholder="John Doe" class="border border-gray-200 text-gray-900 rounded-lg focus:ring-gray-200 focus:border-gray-200 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder:text-gray-300 dark:placeholder:text-gray-500 dark:text-gray-400 dark:focus:ring-gray-500 dark:focus:border-gray-500">
                </div>
                <div class="order-6">
                    <label for="twitter" class="block mb-2 dark:text-gray-400 font-medium">
                    ...
                    <input pattern="[a-zA-Z\d_]+" type="text" name="twitter" id="twitter" placeholder="John Doe" class="border border-gray-200 text-gray-900 rounded-lg focus:ring-gray-200 focus:border-gray-200 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder:text-gray-300 dark:placeholder:text-gray-500 dark:text-gray-400 dark:focus:ring-gray-500 dark:focus:border-gray-500">
                </div>
